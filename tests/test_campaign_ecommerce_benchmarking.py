...
print("="*80)
print("TEST CAMPAIGN 3: Competition Benchmarking - D2C E-commerce Platforms")
print("="*80)

# Campaign details
campaign_name = "Competition Benchmarking: D2C E-commerce Platform Positioning Study"
campaign_type = "Competition Benchmarking"
target_industry = "D2C E-commerce"
offer = "Competitive benchmarking study showing positioning, pricing, and customer acquisition strategies across top D2C platforms"
...
linkedin_output = run_linkedin_copy_agent(
    ...
    sender_name="Competitive Intelligence Team",
)
...
for persona, series in linkedin_output.linkedin_series.items():
    ...
    checks = {
        ...
        "M1 references prospect": "allbirds" in m1_lower or "d2c" in m1_lower or "ecommerce" in m1_lower,
