...
print("="*80)
print("TEST CAMPAIGN 2: POV on AI-Powered Supply Chain in 3PL Logistics")
print("="*80)

# Campaign details
campaign_name = "POV: AI-Powered Supply Chain Optimization in Third-Party Logistics"
campaign_type = "POV"
target_industry = "Third-Party Logistics (3PL)"
offer = "Strategic POV on how AI is reshaping 3PL competitive positioning and operations"
...
linkedin_output = run_linkedin_copy_agent(
    ...
    prospect_name="Jennifer Walsh",
    company_name="XPO Logistics",
    sender_name="Strategic Research Team",
)
...
for persona, series in linkedin_output.linkedin_series.items():
    ...
    checks = {
        ...
        "M1 references prospect": "xpo" in m1_lower or "3pl" in m1_lower or "logistics" in m1_lower,
